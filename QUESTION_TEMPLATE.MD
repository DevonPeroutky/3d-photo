```
  ...
  This code is responsible for reading in a PLY gaussian splat and then rendering out equivalent geometries in Rhino8 via a python3 component in Grasshopper to capture the essence of the scene for 3d printing. However, the first screenshot is of the original gaussian splat file and the second screen shot is of the rendered mesh in Rhino.

  # Screenshot 1. Original Gaussian Splat
  /var/folders/mp/fbzgvmdx5sn_nvy557w459pc0000gn/T/TemporaryItems/NSIRD_screencaptureui_R21oWc/Screenshot\ 2025-08-17\ at\ 4.52.23\ PM.png

  # Screenshot 2. Rhino Geometry
  /var/folders/mp/fbzgvmdx5sn_nvy557w459pc0000gn/T/TemporaryItems/NSIRD_screencaptureui_3LuTYZ/Screenshot\ 2025-08-17\ at\ 4.53.49\ PM.png

  As you can see the rhino geometry doesn't seem to capture the essense of the gaussian splat well. Can you help me debug the visual discrepencies? I know there will be some differences just do to Rhino render engine vs 3D software. However, I'm wondering if there are any other improvements to be made. Especially around the shape and rotation and general
  orientation.
